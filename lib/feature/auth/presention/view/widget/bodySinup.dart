...
import 'package:ecommerce2/feature/auth/presention/view/widget/Alert.dart';
import 'package:ecommerce2/feature/auth/presention/view/widget/imageprofile.dart';
import 'package:ecommerce2/feature/auth/presention/view/widget/rowsininsinup.dart';
    ...
    return BlocConsumer<UserCubit, UserState>(
      ...
      builder: (context, state) {
        return BlocConsumer<UserCubit, UserState>(
          ...
          builder: (context, state) {
            return Form(
              key: context.read<UserCubit>().key2,
              child: Padding(
